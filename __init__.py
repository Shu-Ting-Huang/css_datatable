...
# >>> import css_datatable
# >>> css_datatable.create_html(df,title="No Title",file_name="No Name")
#
...
def df2html(df,title="No Title"):
    if hovering==True:
        from css_datatable.style import hover as style_content
    else:
        from css_datatable.style import no_hover as style_content        
